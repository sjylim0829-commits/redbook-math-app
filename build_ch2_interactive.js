    ...
    const SUBSTEP_CONFIG = {
      ...
      '1-1': {
        ...
        formHtml: \`
          <div class="card" style="background:#ffffff; border:2px solid #cbd5e1; padding:18px; border-radius:12px;">
            ...
            <div style="font-size:0.92rem; margin-bottom:14px; line-height:2.2;">
              ① 로봇을 동쪽으로 3m 후 서쪽으로 5m 이동했을 때 최종 위치: ( <input type="text" id="p11-robot-pos" class="proof-input-text" style="width:70px;" placeholder="-2 등"> ) m<br>
              ② 영상 5℃를 +5℃로 나타낼 때, 영하 7℃는: ( <input type="text" id="p11-temp2" class="proof-input-text" style="width:70px;" placeholder="-7 등"> ) ℃<br>
              ③ 1000원 이익을 +1000원으로 나타낼 때, 500원 손해는: ( <input type="text" id="p11-money" class="proof-input-text" style="width:80px;" placeholder="-500 등"> ) 원
            </div>
        ...
        formHtml: \`
          <div class="card" style="background:#ffffff; border:2px solid #cbd5e1; padding:18px; border-radius:12px;">
            ...
            <div style="font-size:0.92rem; margin-bottom:14px; line-height:2.2;">
              ...
              • 0은 양수인가요, 음수인가요, 둘 다 아닌가요? ( <input type="text" id="p12-zero" class="proof-input-text" style="width:150px;" placeholder="둘 다 아니다 등"> )
            </div>
        ...
        formHtml: \`
          <div class="card" style="background:#ffffff; border:2px solid #cbd5e1; padding:18px; border-radius:12px;">
            <div style="font-size:0.92rem; margin-bottom:14px; line-height:2.2;">
              ...
              ② 수직선에서 0의 왼쪽으로 2.5칸 떨어진 점에 대응하는 수: ( <input type="text" id="p13-q2" class="proof-input-text" style="width:90px;" placeholder="-2.5 또는 -5/2"> )
            </div>
        ...
        formHtml: \`
          <div class="card" style="background:#ffffff; border:2px solid #cbd5e1; padding:18px; border-radius:12px;">
            ...
            <div style="font-size:0.92rem; margin-bottom:14px; line-height:2.2;">
              ...
              ③ 절댓값이 4인 수를 모두 쓰시오: ( <input type="text" id="p14-q3" class="proof-input-text" style="width:110px;" placeholder="예: +4, -4"> )
            </div>
      ...
      '2-2': {
        ...
        formHtml: \`
          <div class="card" style="background:#ffffff; border:2px solid #cbd5e1; padding:18px; border-radius:12px;">
            <div style="font-size:0.92rem; margin-bottom:14px; line-height:2.2;">
              ① '$x$는 $-2$ 이상이다': $x$ ( <input type="text" id="p22-q1" class="proof-input-text" style="width:60px;" placeholder=">= 등"> ) $-2$<br>
              ② '$x$는 3보다 크지 않다(작거나 같다)': $x$ ( <input type="text" id="p22-q2" class="proof-input-text" style="width:60px;" placeholder="<= 등"> ) $3$<br>
              ③ '$x$는 $-1$ 초과이고 5 이하이다': ( <input type="text" id="p22-q3" class="proof-input-text" style="width:160px;" placeholder="-1 < x <= 5"> )
            </div>
      ...
      '3-2': {
        ...
        formHtml: \`
          <div class="card" style="background:#ffffff; border:2px solid #cbd5e1; padding:18px; border-radius:12px;">
            <div style="font-size:0.92rem; margin-bottom:14px; line-height:2.2;">
              ① $a + b = b + a$ 는 덧셈의 ( <input type="text" id="p32-law1" class="proof-input-text" style="width:110px;" placeholder="교환법칙"> )<br>
              ② $(a + b) + c = a + (b + c)$ 는 덧셈의 ( <input type="text" id="p32-law2" class="proof-input-text" style="width:110px;" placeholder="결합법칙"> )<br>
      ...
      '4-3': {
        ...
        formHtml: \`
          <div class="card" style="background:#ffffff; border:2px solid #cbd5e1; padding:18px; border-radius:12px;">
            <div style="font-size:0.92rem; margin-bottom:14px; line-height:2.2;">
              ① $-\\\\frac{3}{5}$의 역수는: ( <input type="text" id="p43-recip" class="proof-input-text" style="width:80px;" placeholder="-5/3"> )<br>
        ...
        formHtml: \`
          <div class="card" style="background:#ffffff; border:2px solid #cbd5e1; padding:18px; border-radius:12px;">
            <div style="font-size:0.92rem; margin-bottom:14px; line-height:2.2;">
              ...
              ② $a &lt; 0, b &gt; 0$ 일 때, $a \\\\times b$ 의 부호는 (양수 / 음수): ( <input type="text" id="p51-q2" class="proof-input-text" style="width:80px;" placeholder="음수 등"> )
            </div>
